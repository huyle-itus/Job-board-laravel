...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-100 from-10% via-sky-200 via-30% to-emerald-100 to-90%">
        <nav class="mb-8 flex justify-between text-lg font-medium">
            ...
            <ul class="flex space-x-4">
                @auth
                    <li class="text-slate-800 font-medium hover:text-black">
